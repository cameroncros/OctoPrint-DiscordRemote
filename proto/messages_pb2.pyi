...
class Command(_message.Message):
    ...
    connected: bool
    file: File
    def __init__(self, command: _Optional[str] = ..., connected: bool = ..., file: _Optional[_Union[File, _Mapping]] = ...) -> None: ...
...
class EmbedContent(_message.Message):
    ...
    description: str
    snapshot: File
    textfield: _containers.RepeatedCompositeFieldContainer[Field]
    title: str
    def __init__(self, title: _Optional[str] = ..., description: _Optional[str] = ..., author: _Optional[str] = ..., color: _Optional[int] = ..., snapshot: _Optional[_Union[File, _Mapping]] = ..., textfield: _Optional[_Iterable[_Union[Field, _Mapping]]] = ...) -> None: ...
...
class Response(_message.Message):
    __slots__ = ["embed", "presence"]
    EMBED_FIELD_NUMBER: _ClassVar[int]
    PRESENCE_FIELD_NUMBER: _ClassVar[int]
    embed: EmbedContent
    presence: Presence
    def __init__(self, embed: _Optional[_Union[EmbedContent, _Mapping]] = ..., presence: _Optional[_Union[Presence, _Mapping]] = ...) -> None: ...
