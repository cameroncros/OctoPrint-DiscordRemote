...
class OctoRantPlugin(octoprint.plugin.EventHandlerPlugin, octoprint.plugin.StartupPlugin):
    def __init__(self):
	self.url = "https://discordapp.com/api/webhooks/348130170160283651/3Adv1yAweHM1ryA9yEOGHSYwp6U-yuhh4WbksVubYwgv8ATPrMHwdVOFXUUPbrdlu_RD"

    def on_after_startup(self):
        self._logger.info("OctoRant has started !")
	wh = WebHook(self.url, "OctoRant has started!")
	wh.post()
